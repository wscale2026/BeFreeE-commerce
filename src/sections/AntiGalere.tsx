...
export default function AntiGalere() {
  ...
  return (
    <section id="anti-galere" className="py-20 md:py-28 bg-white" ref={ref}>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {CARDS.map((card, idx) => {
            ...
            return (
              ...
              >
                <div
                  className={`w-12 h-12 rounded-xl ${card.bg} ${card.color} flex items-center justify-center mb-5`}
                >
