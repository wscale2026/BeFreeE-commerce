  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className={`w-8 h-8 rounded-full flex items-center justify-center bg-brand-gray flex-shrink-0 transition-transform duration-300 ${
            isOpen ? "rotate-180" : ""
          }`}
        >
...
export default function FAQ() {
  ...
  return (
    <section id="faq" className="py-20 md:py-28 bg-brand-gray" ref={ref}>
